...
# Passage sur le SIG 
  ...
  Afin de pouvoir produire des cartes présentables aux élus et/ou à d'autres forestiers, il est nécessaire de créer un géopackage regroupant l'ensemble des couches produites durant cette étude. En faisant cela, il ne restera plus qu'au gestionnaire de choisir sa ssymbologie selon ses habitudes afin d'obtenir des cartes claires et précises. 
...
# Conclusion 
  ...
  Il a été observé plusieurs points pouvant peser différents types de pression sur la forêt étudiée. Le gestionnaire, grâce à ses données et aux cartes générées sur SIG, peut désormais agir en conséquence pour produire un plan d'aménagement cohérent et en prenant en compte le regard du public et des conséquences de leur passage en forêt. 
